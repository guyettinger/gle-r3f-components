import{P as B,u as x,D as d,a as D,V as N,j as u,s as R,C as W}from"./react-three-fiber.esm-af5de61a.js";import{r as e}from"./index-76fb7be0.js";import{v as M,m as k,i as I}from"./index-0332b2ed.esm-559105d7.js";import{_ as g}from"./extends-98964cd2.js";import"./_commonjsHelpers-de833af9.js";const S=M>=154?"opaque_fragment":"output_fragment";class $ extends B{constructor(r){super(r),this.onBeforeCompile=(a,s)=>{const{isWebGL2:o}=s.capabilities;a.fragmentShader=a.fragmentShader.replace(`#include <${S}>`,`
...
`,v=({children:t})=>u(V,{className:"gle-background-canvas",camera:{position:[0,0,1]},children:t});try{v.displayName="CanvasBackground",v.__docgenInfo={description:"",displayName:"CanvasBackground",props:{}}}catch{}const Y={component:h,title:"gle-r3f-components/Stars",argTypes:{}},T=R.div`
  width: 100vw;
  height: 100vh;
...
//# sourceMappingURL=Stars.stories-9a91abeb.js.map
