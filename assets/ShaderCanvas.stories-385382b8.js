import{c as f,u as h,j as a,C as y,d as o,e as g,s as b}from"./react-three-fiber.esm-886f195d.js";import{s as v}from"./shaderMaterial-5b88eac9.js";import"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";const s=({shaderMaterial:t,renderCallback:e,...l})=>{const{viewport:i}=f();return h(e),a("mesh",{material:t,children:a("planeGeometry",{attach:"geometry",args:[i.width,i.height],...l})})};try{s.displayName="ShaderPlane",s.__docgenInfo={description:"",displayName:"ShaderPlane",props:{shaderMaterial:{defaultValue:null,description:"",name:"shaderMaterial",required:!0,type:{name:"ShaderMaterial"}},renderCallback:{defaultValue:null,description:"",name:"renderCallback",required:!0,type:{name:"RenderCallback"}},id:{defaultValue:null,description:"Unique number for this {@link THREE.BufferGeometry BufferGeometry} instance.\n@remarks Expects a `Integer`",name:"id",required:!1,type:{name:"number"}},uuid:{defaultValue:null,description:`{@link http://en.wikipedia.org/wiki/Universally_unique_identifier UUID} of this object instance.
@remarks This gets automatically assigned and shouldn't be edited.`,name:"uuid",required:!1,type:{name:"string"}},name:{defaultValue:null,description:"Optional name for this {@link THREE.BufferGeometry BufferGeometry} instance.\n@defaultValue `''`",name:"name",required:!1,type:{name:"string"}},type:{defaultValue:null,description:"A Read-only _string_ to check if `this` object type.\n@remarks Sub-classes will update this value.\n@defaultValue `PlaneGeometry`",name:"type",required:!1,type:{name:"string"}},index:{defaultValue:null,description:`Allows for vertices to be re-used across multiple triangles; this is called using "indexed triangles".
...
@defaultValue \`null\``,name:"index",required:!1,type:{name:"BufferAttribute | null"}},attributes:{defaultValue:null,description:"This hashmap has as id the name of the attribute to be set and as value the {@link THREE.BufferAttribute buffer} to set it to. Rather than accessing this property directly,\nuse {@link setAttribute.setAttribute} and {@link getAttribute.getAttribute} to access attributes of this geometry.\n@defaultValue `{}`",name:"attributes",required:!1,type:{name:"NormalBufferAttributes"}},morphAttributes:{defaultValue:null,description:`Hashmap of {@link THREE.BufferAttribute BufferAttributes} holding details of the geometry's morph targets.
...
@defaultValue \`[]\``,name:"groups",required:!1,type:{name:"GeometryGroup[]"}},boundingBox:{defaultValue:null,description:"Bounding box for the {@link THREE.BufferGeometry BufferGeometry}, which can be calculated with {@link computeBoundingBox.computeBoundingBox()}.\n@remarks Bounding boxes aren't computed by default. They need to be explicitly computed, otherwise they are `null`.\n@defaultValue `null`",name:"boundingBox",required:!1,type:{name:"Box3 | null"}},boundingSphere:{defaultValue:null,description:"Bounding sphere for the {@link THREE.BufferGeometry BufferGeometry}, which can be calculated with {@link computeBoundingSphere.computeBoundingSphere()}.\n@remarks bounding spheres aren't computed by default. They need to be explicitly computed, otherwise they are `null`.\n@defaultValue `null`",name:"boundingSphere",required:!1,type:{name:"Sphere | null"}},drawRange:{defaultValue:null,description:`Determines the part of the geometry to render. This should not be set directly, instead use {@link setDrawRange.setDrawRange(...)}.
...
@param points`,name:"setFromPoints",required:!1,type:{name:"((points: Vector3[] | Vector2[]) => PlaneGeometry)"}},computeBoundingBox:{defaultValue:null,description:`Computes the bounding box of the geometry, and updates the {@link .boundingBox} attribute. The bounding box is
not computed by the engine; it must be computed by your app. You may need to recompute the bounding box if the
geometry vertices are modified.`,name:"computeBoundingBox",required:!1,type:{name:"(() => void)"}},computeBoundingSphere:{defaultValue:null,description:`Computes the bounding sphere of the geometry, and updates the {@link .boundingSphere} attribute. The engine
automatically computes the bounding sphere when it is needed, e.g., for ray casting or view frustum culling. You
may need to recompute the bounding sphere if the geometry vertices are modified.`,name:"computeBoundingSphere",required:!1,type:{name:"(() => void)"}},computeTangents:{defaultValue:null,description:`Calculates and adds a tangent attribute to this geometry.
...
void main() {
  ...
  }`,p=v({uTime:0,uColorStart:new o("blue"),uColorEnd:new o("white")},x,k);g({PortalMaterial:p});const w={component:n,title:"gle-r3f-components/ShaderCanvas",argTypes:{}},T=b.div`
  width: 100vw;
  height: 100vh;
...
}`,...(m=(d=r.parameters)==null?void 0:d.docs)==null?void 0:m.source}}};const q=["PortalShader"];export{r as PortalShader,q as __namedExportsOrder,w as default};
//# sourceMappingURL=ShaderCanvas.stories-385382b8.js.map
