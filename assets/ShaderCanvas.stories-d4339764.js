import{c as f,u as h,j as a,C as y,d as l,e as g,s as b}from"./react-three-fiber.esm-af5de61a.js";import{s as v}from"./shaderMaterial-6fac7b2a.js";import"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";import"./extends-98964cd2.js";const o=({shaderMaterial:e,renderCallback:t,...s})=>{const{viewport:i}=f();return h(t),a("mesh",{material:e,children:a("planeGeometry",{attach:"geometry",args:[i.width,i.height],...s})})};try{o.displayName="ShaderPlane",o.__docgenInfo={description:"",displayName:"ShaderPlane",props:{shaderMaterial:{defaultValue:null,description:"",name:"shaderMaterial",required:!0,type:{name:"ShaderMaterial"}},renderCallback:{defaultValue:null,description:"",name:"renderCallback",required:!0,type:{name:"RenderCallback"}},id:{defaultValue:null,description:"Unique number for this {@link THREE.BufferGeometryBufferGeometry} instance.\n@remarks Expects a `Integer`",name:"id",required:!1,type:{name:"number"}},uuid:{defaultValue:null,description:`{@link http://en.wikipedia.org/wiki/Universally_unique_identifier UUID} of this object instance.
...
void main() {
  ...
  }`,p=v({uTime:0,uColorStart:new l("blue"),uColorEnd:new l("white")},x,k);g({PortalMaterial:p});const q={component:r,title:"gle-r3f-components/ShaderCanvas",argTypes:{}},T=b.div`
  width: 100vw;
  height: 100vh;
`,n=e=>{const t=new p;return a(T,{children:a(r,{shaderMaterial:t,renderCallback:(i,c)=>{t.uniforms.uTime.value+=c}})})};n.args={};var u,d,m;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`(args: any) => {
...
}`,...(m=(d=n.parameters)==null?void 0:d.docs)==null?void 0:m.source}}};const P=["PortalShader"];export{n as PortalShader,P as __namedExportsOrder,q as default};
//# sourceMappingURL=ShaderCanvas.stories-d4339764.js.map
